...
export default function CardLink({ wallet_address, link, title, description, published_date, love_counter }: CardLinkProps) {
  return (
    <div className="flex flex-col justify-between h-64 border border-white/20 bg-lavender-blue/80 backdrop-blur-xl rounded-3xl p-6 shadow-2xl shadow-blue-500/10 hover:shadow-blue-500/20 transition-all duration-300 hover:scale-[1.02] relative overflow-hidden">
      ...
      <div className="flex justify-between relative z-10">
        <div className="flex items-center gap-2">
          <Image
            ...
            height={40}
          />
          <span className="font-sherika text-light-blue">{wallet_address}</span>
        </div>
        <Link
          href={link}
          target="_blank"
